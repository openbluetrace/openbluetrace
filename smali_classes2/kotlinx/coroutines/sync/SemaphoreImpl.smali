...
.method public static final synthetic access$getTail$p(Lkotlinx/coroutines/sync/SemaphoreImpl;)Lkotlinx/coroutines/sync/SemaphoreSegment;
    ...
    .line 1
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/SegmentQueue;->getTail()Lkotlinx/coroutines/internal/Segment;
...
.method public final synthetic addToQueueAndSuspend(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 6
    .param p1    # Lkotlin/coroutines/Continuation;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0, v1, v4, v5}, Lkotlinx/coroutines/sync/SemaphoreImpl;->access$getSegment(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/sync/SemaphoreSegment;J)Lkotlinx/coroutines/sync/SemaphoreSegment;
    ...
    .line 6
    iget-object v2, v1, Lkotlinx/coroutines/sync/SemaphoreSegment;->acquirers:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    .line 7
    iget-object v4, v1, Lkotlinx/coroutines/sync/SemaphoreSegment;->acquirers:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-direct {v2, p0, v1, v3}, Lkotlinx/coroutines/sync/CancelSemaphoreAcquisitionHandler;-><init>(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/sync/SemaphoreSegment;I)V
...
.method public final resumeNextFromQueue$kotlinx_coroutines_core()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/SegmentQueue;->getHead()Lkotlinx/coroutines/internal/Segment;
    ...
    invoke-virtual {p0, v0, v3, v4}, Lkotlinx/coroutines/internal/SegmentQueue;->getSegmentAndMoveHead(Lkotlinx/coroutines/internal/Segment;J)Lkotlinx/coroutines/internal/Segment;
